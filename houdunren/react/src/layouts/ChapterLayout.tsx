  ...
  ({ title, description, children }, ref) => {
    return (
      <main className='mx-3 lg:container bg-white rounded-lg p-6' ref={ref}>
        <h1 className='flex justify-center text-3xl mt-12 font-bold bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text text-transparent hover:scale-125 transition-transform duration-300 ease-in-out'>
          {title}
        </h1>
